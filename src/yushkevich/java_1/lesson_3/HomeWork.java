...
package yushkevich.java_1.lesson_3;
...
public class HomeWork {
    ...
    private static void guessNumb() {
        ...
        while (true) {                                                                                   //создал цикл, который выполняется пока условие истина
            ...
            System.out.printf("Угадайте число от 0 до %d. Осталось попыток: %d%n", range, counter + 1);  //сообщение, которое задает условие и сообщвет оставшееся кол-во попыток
